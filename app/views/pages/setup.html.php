...
$checks = array(
	...
	'dbSupport' => function() use ($support) {
		...
		return $support('Database support (available adapters)', $map);
	},
...
?>
<div>
	<h3>Powered by <a href="http://lithify.me/">Lithium</a>.</h3>
</div>
...
<p>
	See the
	<?php echo $this->html->link('wiki', 'https://github.com/nZEDb/nZEDb/wiki'); ?>
	for explanations and tutorials.
</p>

<h3>Community</h3>
<p>
	Support from other users and the team developing  nZEDb can be found in the <?php echo $this->html->link('forums', 'http://nzedb.com'); ?>.
</p>
